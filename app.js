...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function saveToHistory() {
        ...
        history.unshift(entry); // Ajoute au début
    ...
    function loadFromHistory(id) {
        ...
        // Réinitialise et recrée les sections dynamiques
        ...
        // Remplit les valeurs dans les cartes créées
        setTimeout(() => {
        ...
        if (history.length === 0) {
            dom.historyList.innerHTML = `
                <div class="history-empty">
                    ...
                    <p>Utilisez le bouton "Télécharger PDF" pour sauvegarder une version.</p>
                </div>`;
            return;
        }
    ...
    function renderCV() {
        ...
        // Application de la variante de design (marges)
        ...
        // Tri chronologique (En cours en premier)
    ...
    // Fonction Helper pour construire les sections communes
    function buildSections(exps, edus, modern = false) {
        ...
        if (exps.length) {
            ...
            exps.forEach(e => {
                // ✅ Badge "En cours" à DROITE uniquement (colonne date)
    ...
    // Fonction centrale : Collecte les données DU FORMULAIRE vers l'ÉTAT, puis rend
    function syncAndRender() {
        ...
        // IMPORTANT : On recalcule les tableaux dynamiques directement depuis le DOM
    ...
    // Collecte les valeurs des cartes dynamiques
    ...
    // Ajoute une nouvelle carte (Exp, Edu, etc.)
    ...
    // Remplit une carte existante avec des données (utilisé par le chargement historique)
    ...
    // Trie les éléments (En cours en premier)
    ...
    // Formate la description (listes à puces automatiques)
    ...
    // Inputs statiques (Nom, Prénom, etc.)
    ...
    // ✅ CORRECTION : Attache les événements DIRECTEMENT sur les boutons de compétences
    ...
    dom.downloadBtn.addEventListener('click', () => {
        ...
        // Clone propre sans transform pour le PDF
        ...
        html2pdf().set({ 
            ...
            // ✅ TRACKING GA4 : Compte le téléchargement
